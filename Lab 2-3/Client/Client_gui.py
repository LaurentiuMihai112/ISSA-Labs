...
class Ui_MainWindow(object):
    ...
    def send_on_data(self):
        try:
            self.client.send(rsa_library.encrypt(public_key, airbag_on).encode())
    ...
    def send_corrupted_low(self):
        try:
            self.client.send(rsa_library.encrypt(public_key, corrupted_low).encode())
        except Exception as e:
            print(str(e))
    ...
    def send_corrupted_high(self):
        try:
            self.client.send(rsa_library.encrypt(public_key, corrupted_high).encode())
        except Exception as e:
            print(str(e))
